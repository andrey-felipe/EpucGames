...
namespace EpucGames.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdFornecedor,NomeFornecedor,TelefoneFornecedor,ComissaoFornecedor")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFornecedor,NomeFornecedor,TelefoneFornecedor,ComissaoFornecedor")] Fornecedor fornecedor)
        {
